...
export class TaskParameters {
    ...
    private _azureSourceBranch: string;
    ...
    private constructor() {
        ...
        this._azureSourceBranch = core.getInput('azure-source-branch', {required: false});
    ...
    public get azureSourceBranch() {
        return this._azureSourceBranch;
    }
}